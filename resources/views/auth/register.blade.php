...
@section('content')
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group row">
                <label for="role" class="col-md-4 col-form-label text-md-right">{{ __('Screen Name') }}</label>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="role" type="email" class="form-control{{ $errors->has('role') ? ' is-invalid' : '' }}" name="role" value="{{ old('role') }}" required>
