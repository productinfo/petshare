    ...
    <div class="card-body">
        ...
        @if ($user->role === 'owner')
            <div class="row mt-2 mb-4">
                <div class="col-md-5 offset-md-3">With the role of a "pet owner:"  <a href="{{ route('pets.create') }}" class="btn btn-primary btn-lg ml-2">CREATE PET PROFILE</a>
                </div>
            </div>
        @else
            <div class="row mt-2 mb-4">
                <div class="col-md-5 offset-md-3">With the role of "non-pet owner": <a href="{{ route('pets.search') }}" class="btn btn-primary btn-lg ml-2">SEARCH FOR PETS</a>
                </div>
            </div>
        @endif
        ...
        <div class="row my-2">
            ...
            <div class="col-6"><img alt="{{Auth::user()->getName()}}" src="{{Auth::user()->image}}"/></div>
        </div>
